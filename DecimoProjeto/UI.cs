	...
	class UI
	{
		...
		public void InitializeUI()
		{
			...
			do
			{
				...
				Console.WriteLine("Digite H para Data e Hora.");
				...
				switch (temp)
				{
					case "c":
						// Cadastrar
						if (Database.AvaliableDB() == false)
						{

							Console.WriteLine("Base de dados indisponível");
							break;
						}
						else
						{
					...
					case "h":
						...
						Console.Clear();
						PrintMessage("A data e hora atual é: "+DateTime.Now.ToString());
						break;
